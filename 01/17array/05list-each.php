...
$arr2=['city'=>'唐山','保定','秦皇岛'];
echo '<pre>';
print_r(each($arr2)); //形成数组，元素有：0=>city,1=>'唐山',key=>city,value=>'唐山';
print_r(each($arr2)); //形成数组，元素有：0=>0,1=>'保定',key=>0,value=>'保定';
print_r(each($arr2)); //形成数组，元素有：0=>1,1=>'秦皇岛',key=>1,value=>'秦皇岛';
echo '<pre>';
